{ stdenv, fetchurl }:
  ...
  in {
    ...
    echarts-api = mkJenkinsPlugin {
      name = "echarts-api";
      src = fetchurl {
        url = "https://updates.jenkins-ci.org/download/plugins/echarts-api/5.6.0-3/echarts-api.hpi";
        sha256 = "5881c54abfad52d162bf9510d737bcbb0e0453303b7169b6548303f29b6cd749";
        };
      };
    ...
    pipeline-graph-view = mkJenkinsPlugin {
      ...
      src = fetchurl {
        url = "https://updates.jenkins-ci.org/download/plugins/pipeline-graph-view/458.vda_20b_9b_63f10/pipeline-graph-view.hpi";
        sha256 = "199ef7ae2da527b52f1e6b75d3aad4d82e1fc5d779786c0651949457319f9fa4";
        };
      };
    ...
    support-core = mkJenkinsPlugin {
      name = "support-core";
      src = fetchurl {
        url = "https://updates.jenkins-ci.org/download/plugins/support-core/1718.vb_3b_47b_e0b_8d3/support-core.hpi";
        sha256 = "108a58eb41445754c81e93007f97006249ca1514425b84b09543ab2306152a7b";
        };
      };
